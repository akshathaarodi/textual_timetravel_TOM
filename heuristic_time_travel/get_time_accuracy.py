...
folder_path = "outputs-mnn3.14/time_"
#folder_path = ""
...
if split == "test":
    split_pred = "_test"
counter = 0
prediction_file = folder_path + "mypredictions" + split_pred + ".txt"
#prediction_file = folder_path + "bestpredictions" + split_pred + ".txt"
